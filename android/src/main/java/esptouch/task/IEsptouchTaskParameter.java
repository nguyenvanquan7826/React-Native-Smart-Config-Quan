...
public interface IEsptouchTaskParameter {
    ...
    /**
     * get interval millisecond for guide code(the timeText between each guide code sending)
     *
     * @return interval millisecond for guide code(the timeText between each guide code sending)
     */
    long getIntervalGuideCodeMillisecond();

    /**
     * get interval millisecond for data code(the timeText between each data code sending)
     *
     * @return interval millisecond for data code(the timeText between each data code sending)
     */
    long getIntervalDataCodeMillisecond();

    /**
     * get timeout millisecond for guide code(the timeText how much the guide code sending)
     *
     * @return timeout millisecond for guide code(the timeText how much the guide code sending)
     */
    long getTimeoutGuideCodeMillisecond();

    /**
     * get timeout millisecond for data code(the timeText how much the data code sending)
     *
     * @return timeout millisecond for data code(the timeText how much the data code sending)
     */
    ...
    /**
     * get total repeat timeText for executing esptouch task
     *
     * @return total repeat timeText for executing esptouch task
     */
